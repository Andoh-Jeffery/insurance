    ...
    <div class="main-wrapper">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="claimd mb-30">
                            <div class="claimd-body pt-30">
                                <h4 class="font-20 ">claims</h4>
                            </div>
                                ...
                                <table class="text-nowrap dh-table" id="example" class="display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$claim->claim_freq}}</td>
                                            <td>{{$claim->old_claim}}</td>
                                            <td>
                                                <div class="icon" style="padding:20px">
                                                    <a class="material-icons" title="edit"
                                                        href="/update-claim/{{$claim->id}}">build</a>
                                                </div>
                                                <div class="icon">
                                                    <form action="/delete-claim/{{$claim->id}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
